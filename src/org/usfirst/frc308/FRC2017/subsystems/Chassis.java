...
public class Chassis extends PIDSubsystem {
 ...
 public void initArcade() {
 	//basicDrive = new RobotDrive(left1, left2, right1, right2);
 	robotDrive6.setSafetyEnabled(false);
    robotDrive6.setExpiration(0.1);
    robotDrive6.setSensitivity(0.5);
    robotDrive6.setMaxOutput(1.0);
 }
