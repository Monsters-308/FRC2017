...
public class AutonomousTrajectoryFollowerThreePoint extends Command {
	...
	public AutonomousTrajectoryFollowerThreePoint(double x0, double y0, double d0, double x1, double y1, double d1,
			double x2, double y2, double d2, boolean driveforward) {
	...
	protected void initialize() {
		...
		// new Waypoint(-4, -1, Pathfinder.d2r(-45)), // Waypoint @ x=-4, y=-1,
		...
		// The fifth argument is your acceleration gain. Tweak this if you want
		// to get to a higher or lower speed quicker
		...
		t.schedule(new TimerTask() {
			...
			//
			// double gyro_heading = ... your gyro code here ... // Assuming the
			// gyro is giving a value in degrees
			...
			public void run() {
				...
				double gyro_heading = Robot.chassis.getGyroAngle(); // Assuming
																	// the gyro
																	// is giving
																	// a value
																	// in
