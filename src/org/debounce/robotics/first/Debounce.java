package org.debounce.robotics.first;
...
public class Debounce {
	 ...
	 * 		the local scope. 
	 **************************************************************************/
	public Debounce(int button) {
		joy = Robot.oi.getJoystick1();	//Scope is important, y'all. 
		this.button = button;
		
		lastState = getButton(button);
	...
	public boolean getButton(int btnNum){
        ...
        return this.joy.getRawButton(btnNum);
	}
